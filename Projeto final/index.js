...
dica: existe a possibilidade de criar uma função para detectar todos as pressionamento ao mesmo tempo.

3) Criar uma função chamada FazerSom e nessa função, usando laço "if/else" ou "swith/case" para verificar 
se o usuário clicou a letra minúscula (caps lock ativado). Após a verificação, ao clicar o som equivalente
 a tecla tem que ser acionada.
